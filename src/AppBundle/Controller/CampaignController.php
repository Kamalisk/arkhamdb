...
class CampaignController extends Controller
{
    ...
    public function listAction ()
    {
        ...
        $usercampaigns = $this->get('usercampaigns')->getByUser($user, FALSE);

        if(count($decks))
        {
	      	return $this->render('AppBundle:Builder:campaigns.html.twig',
      			array(
      					'pagetitle' => "My Campaigns",
      					'pagedescription' => "Create and track campaigns.",
      					'decks' => $usercampaigns,
      					'nbmax' => $user->getMaxNbDecks(),
      					'nbdecks' => count($usercampaigns),
      					'cannotcreate' => $user->getMaxNbDecks() <= count($usercampaigns)
      			));
        }
        else
        {
        	return $this->render('AppBundle:Builder:no-campaigns.html.twig',
        			array(
        					'pagetitle' => "My Campaigns",
        					'pagedescription' => "Create and track campaigns.",
        					'nbmax' => $user->getMaxNbDecks()
